...
describe('scalar', function() {
    ...
    describe('string with <> and interpolation', function() {

        before(function() {
            this.name = this.compile('string-invalid2.yate');
            this.result = this.check(this.name).errors;
        });
        ...
        it('should return error with "propValue" key', function() {
            expect(this.result.getErrorList()[0].error).to.have.property('propValue', '<span style="background:#');
        });
